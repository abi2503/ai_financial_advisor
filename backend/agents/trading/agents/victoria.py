"""
Victoria Sterling - Short-Side Research Director
"""
import sys, os
...
from prompts import victoria as prompt_module
...
class VictoriaAgent(BaseAgent):
    ...
    def vote(self, market_data, holding: dict, mode: str, data_ctx: str) -> AgentVote:
        ...
        try:
            ...
            import logging
            logging.getLogger(__name__).error(f"Victoria Sterling vote error: {e}")
            return AgentVote(
                agent="victoria", action=TradeAction.HOLD,
