"""
Elena Vasquez - Chief Risk Officer
"""
import sys, os
...
from prompts import elena as prompt_module
...
class ElenaAgent(BaseAgent):
    ...
    def vote(self, market_data, holding: dict, mode: str, data_ctx: str) -> AgentVote:
        ...
        try:
            ...
            import logging
            logging.getLogger(__name__).error(f"Elena Vasquez vote error: {e}")
            return AgentVote(
                agent="elena", action=TradeAction.HOLD,
