"""
Reid Morrison - Chief Macro Strategist
"""
import sys, os
...
from prompts import reid as prompt_module
...
class ReidAgent(BaseAgent):
    ...
    def vote(self, market_data, holding: dict, mode: str, data_ctx: str) -> AgentVote:
        ...
        try:
            ...
            import logging
            logging.getLogger(__name__).error(f"Reid Morrison vote error: {e}")
            return AgentVote(
                agent="reid", action=TradeAction.HOLD,
